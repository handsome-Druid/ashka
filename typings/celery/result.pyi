...
E_WOULDBLOCK = ...
def assert_will_not_block(): # -> None:
    ...

@contextmanager
def allow_join_result(): # -> Generator[None, Any, None]:
    ...

@contextmanager
def denied_join_result(): # -> Generator[None, Any, None]:
    ...
...
class AsyncResult(ResultBase):
    ...
    def then(self, callback, on_error=..., weak=...): # -> promise | Thenable:
        ...
    
    def as_tuple(self): # -> tuple[tuple[Any | None, Any | None], None]:
        ...
    ...
    def revoke(self, connection=..., terminate=..., signal=..., wait=..., timeout=...): # -> None:
    ...
    def revoke_by_stamped_headers(self, headers, connection=..., terminate=..., signal=..., wait=..., timeout=...): # -> None:
    ...
    def get(self, timeout=..., propagate=..., interval=..., no_ack=..., follow_parents=..., callback=..., on_message=..., on_interval=..., disable_sync_subtasks=..., EXCEPTION_STATES=..., PROPAGATE_STATES=...): # -> None:
    ...
    wait = ...
    def collect(self, intermediate=..., **kwargs): # -> Generator[tuple[Self, Any | None], Any, None]:
    ...
    def get_leaf(self): # -> None:
        ...
    
    def iterdeps(self, intermediate=...): # -> Generator[tuple[None, Self], Any, None]:
        ...
    ...
    maybe_reraise = ...
    def build_graph(self, intermediate=..., formatter=...): # -> DependencyGraph:
        ...
    ...
    def __reduce__(self): # -> tuple[type[Self], tuple[Any | None, Any | None, None, None, Any | None]]:
        ...
    
    def __reduce_args__(self): # -> tuple[Any | None, Any | None, None, None, Any | None]:
        ...
...
class ResultSet(ResultBase):
    ...
    def maybe_throw(self, callback=..., propagate=...): # -> None:
        ...
    ...
    def get(self, timeout=..., propagate=..., interval=..., callback=..., no_ack=..., on_message=..., disable_sync_subtasks=..., on_interval=...): # -> list[None] | list[Any] | None:
        """See :meth:`join`.
    ...
    def join(self, timeout=..., propagate=..., interval=..., callback=..., no_ack=..., on_message=..., disable_sync_subtasks=..., on_interval=...): # -> list[Any]:
    ...
    def iter_native(self, timeout=..., interval=..., no_ack=..., on_message=..., on_interval=...): # -> Any:
    ...
    def join_native(self, timeout=..., propagate=..., interval=..., callback=..., no_ack=..., on_message=..., on_interval=..., disable_sync_subtasks=...): # -> list[None] | None:
    ...
    @property
    def supports_native_join(self): # -> None:
        ...
...
class GroupResult(ResultSet):
    ...
    def __reduce__(self): # -> tuple[type[Self], tuple[Any | None, None]]:
        ...
    
    def __reduce_args__(self): # -> tuple[Any | None, None]:
        ...
    ...
    def as_tuple(self): # -> tuple[tuple[Any | None, Any | None], list[Any]]:
        ...
...
class EagerResult(AsyncResult):
    ...
    def __init__(self, id, ret_value, state, traceback=..., name=...) -> None:
        ...
    
    def then(self, callback, on_error=..., weak=...): # -> promise | Thenable:
        ...
    
    def __reduce__(self): # -> tuple[type[Self], tuple[Any, Any, Any | str, Any | None]]:
        ...
    
    def __reduce_args__(self): # -> tuple[Any, Any, Any | str, Any | None]:
        ...
    ...
    def get(self, timeout=..., propagate=..., disable_sync_subtasks=..., **kwargs): # -> Any | None:
        ...
    ...
    @property
    def supports_native_join(self): # -> Literal[False]:
        ...
