...
def join(l: list[str], sep: str = ...) -> str:
...
def pluralize(n: float, text: str, suffix: str = ...) -> str:
...
def simple_format(s: str, keys: dict[str, str | Callable], pattern: Pattern[str] = ..., expand: str = ...) -> str:
...
class WhateverIO(StringIO):
    ...
    def __init__(self, v: bytes | str | None = ..., *a: Any, **kw: Any) -> None:
        ...
