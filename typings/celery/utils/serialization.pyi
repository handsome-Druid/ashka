...
def itermro(cls, stop): # -> takewhile:
    ...
...
def ensure_serializable(items, encoder): # -> tuple[Any, ...]:
...
class UnpickleableExceptionWrapper(Exception):
    ...
    @classmethod
    def from_exception(cls, exc): # -> Self:
        ...
...
def jsonify(obj, builtin_types=..., key=..., keyfilter=..., unknown_type_filter=...): # -> dict[str, Any] | list[Any] | dict[str | Any, Any] | str | None:
