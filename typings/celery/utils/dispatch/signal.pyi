...
class Signal:
    ...
    def connect(self, *args, **kwargs): # -> Callable[..., Any | None] | Callable[..., object] | Callable[..., Callable[..., Any | None] | Any]:
    ...
    def disconnect(self, receiver=..., sender=..., weak=..., dispatch_uid=...): # -> bool:
