...
def iter_open_logger_fds(): # -> Generator[Any, Any, None]:
    ...

@contextmanager
def in_sighandler(): # -> Generator[None, Any, None]:
    """Context that records that we are in a signal handler."""
    ...

def logger_isa(l, p, max=...): # -> bool:
    ...
...
def current_process(): # -> _MainProcess | None:
    ...

def current_process_index(base=...): # -> Any | None:
    ...
