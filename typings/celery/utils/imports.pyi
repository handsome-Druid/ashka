...
@contextmanager
def cwd_in_path(): # -> Generator[str | None, Any, None]:
...
def load_extension_class_names(namespace): # -> Generator[tuple[str, str], Any, None]:
    ...

def load_extension_classes(namespace): # -> Generator[tuple[str, Any | ModuleType], Any, None]:
    ...
