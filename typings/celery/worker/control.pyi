...
logger = ...
controller_info_t = ...
def ok(value): # -> dict[str, Any]:
    ...

def nok(value): # -> dict[str, Any]:
    ...
...
class Panel(UserDict):
    ...
    meta = ...
    @classmethod
    def register(cls, *args, **kwargs): # -> Callable[..., Any]:
        ...
    


def control_command(**kwargs): # -> Callable[..., Any]:
    ...

def inspect_command(**kwargs): # -> Callable[..., Any]:
    ...

@inspect_command()
def report(state): # -> dict[str, Any]:
...
def conf(state, with_defaults=..., **kwargs): # -> dict[str, Any] | list[Any] | dict[str | Any, Any] | str | None:
    """List configuration."""
    ...

@inspect_command(variadic='ids', signature='[id1 [id2 [... [idN]]]]')
def query_task(state, ids, **kwargs): # -> dict[Any, tuple[str, Any]]:
    """Query for task information by id."""
    ...

@control_command(variadic='task_id', signature='[id1 [id2 [... [idN]]]]')
def revoke(state, task_id, terminate=..., signal=..., **kwargs): # -> dict[str, str] | dict[Any, Any]:
...
def revoke_by_stamped_headers(state, headers, terminate=..., signal=..., **kwargs): # -> dict[str, str]:
...
def terminate(state, signal, task_id, **kwargs): # -> dict[str, str] | dict[Any, Any]:
...
@inspect_command()
def clock(state, **kwargs): # -> dict[str, Any]:
...
def hello(state, from_node, revoked=..., **kwargs): # -> dict[str, Any] | None:
...
@control_command()
def pool_restart(state, modules=..., reload=..., reloader=..., **kwargs): # -> dict[str, str]:
...
def add_consumer(state, queue, exchange=..., exchange_type=..., routing_key=..., **options): # -> dict[str, str]:
...
@inspect_command()
def active_queues(state): # -> list[dict[Any, Any]] | list[Any]:
