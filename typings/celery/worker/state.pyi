...
def task_accepted(request, _all_total_count=..., add_request=..., add_active_request=..., add_to_total_count=...): # -> None:
    """Update global state when a task has been accepted."""
    ...

def task_ready(request, successful=..., remove_request=..., discard_active_request=..., discard_reserved_request=...): # -> None:
