...
class Task:
    ...
    def __reduce__(self): # -> tuple[Callable[..., Any], tuple[None, str | None], None]:
        ...
    ...
    def start_strategy(self, app, consumer, **kwargs): # -> Any:
        ...
    ...
    def apply_async(self, args=..., kwargs=..., task_id=..., producer=..., link=..., link_error=..., shadow=..., **options): # -> EagerResult | Any:
    ...
    def signature_from_request(self, request=..., args=..., kwargs=..., queue=..., **extra_options): # -> Signature | None:
        ...
    
    subtask_from_request = ...
    def retry(self, args=..., kwargs=..., exc=..., throw=..., eta=..., countdown=..., max_retries=..., **options): # -> Retry:
    ...
    def apply(self, args=..., kwargs=..., link=..., link_error=..., task_id=..., retries=..., throw=..., logfile=..., loglevel=..., headers=..., **options): # -> EagerResult:
