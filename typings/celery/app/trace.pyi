...
def get_log_policy(task, einfo, exc): # -> log_policy_t:
    ...
...
def get_actual_ignore_result(task, req): # -> Any:
...
class TraceInfo:
    ...
    def handle_failure(self, task, req, store_errors=..., call_errbacks=...): # -> ExceptionInfo:
        """Handle exception."""
        ...
...
def build_tracer(name, task, loader=..., hostname=..., store_errors=..., Info=..., eager=..., propagate=..., app=..., monotonic=..., trace_ok_t=..., IGNORE_STATES=...): # -> Callable[..., Any]:
...
def trace_task_ret(name, uuid, request, body, content_type, content_encoding, loads=..., app=..., **extra_request): # -> tuple[Literal[1], Any, Any] | tuple[Literal[0], Any, Any]:
    ...

def fast_trace_task(task, uuid, request, body, content_type, content_encoding, loads=..., _loc=..., hostname=..., **_): # -> tuple[Literal[1], Any, Any] | tuple[Literal[0], Any, Any]:
    ...

def report_internal_error(task, exc): # -> ExceptionInfo:
    ...
