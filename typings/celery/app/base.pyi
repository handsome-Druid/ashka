...
def pydantic_wrapper(app: Celery, task_fun: typing.Callable[..., typing.Any], task_name: str, strict: bool = ..., context: typing.Optional[typing.Dict[str, typing.Any]] = ..., dump_kwargs: typing.Optional[typing.Dict[str, typing.Any]] = ...): # -> _Wrapped:
...
class Celery:
    ...
    def task(self, *args, **opts): # -> Proxy | Callable[..., Proxy] | Any | PromiseProxy | Callable[..., Any | PromiseProxy]:
    ...
    def type_checker(self, fun, bound=...): # -> staticmethod[Callable[..., Any], Any]:
        ...
    
    def register_task(self, task, **options): # -> TypeIs[type[object]] | type[object] | object:
    ...
    def gen_task_name(self, name, module): # -> LiteralString | str:
        ...
    ...
    def config_from_object(self, obj, silent=..., force=..., namespace=...): # -> Settings | None:
    ...
    def config_from_envvar(self, variable_name, silent=..., force=...): # -> Settings | Literal[False] | None:
    ...
    def config_from_cmdline(self, argv, namespace=...): # -> None:
        ...
    
    def setup_security(self, allowed_serializers=..., key=..., key_password=..., cert=..., store=..., digest=..., serializer=...): # -> None:
    ...
    def send_task(self, name, args=..., kwargs=..., countdown=..., eta=..., task_id=..., producer=..., connection=..., router=..., result_cls=..., expires=..., publisher=..., link=..., link_error=..., add_to_parent=..., group_id=..., group_index=..., retries=..., chord=..., reply_to=..., time_limit=..., soft_time_limit=..., root_id=..., parent_id=..., route_name=..., shadow=..., chain=..., task_type=..., replaced_task_nesting=..., **options):
        """Send task by name.
    ...
    broker_connection = ...
    def connection_or_acquire(self, connection=..., pool=..., *_, **__): # -> FallbackContext:
    ...
    def either(self, default_key, *defaults): # -> MethodType | None:
    ...
    def add_periodic_task(self, schedule, sig, args=..., kwargs=..., name=..., **opts): # -> str:
        """
    ...
    def subclass_with_self(self, Class, name=..., attribute=..., reverse=..., keep_reduce=..., **kw): # -> Any:
    ...
    def __reduce__(self): # -> tuple[Callable[..., Any], tuple[type[Self], Pickler, Any | None, Any | dict[Any, Any] | None, Any | str | None, None, str | Any, str | Any, str | Any, str | Any, Literal[False], Any | None]] | tuple[Callable[..., Any], tuple[type[Self], dict[str, Any]]]:
        ...
    
    def __reduce_v1__(self): # -> tuple[Callable[..., Any], tuple[type[Self], Pickler, Any | None, Any | dict[Any, Any] | None, Any | str | None, None, str | Any, str | Any, str | Any, str | Any, Literal[False], Any | None]]:
        ...
    ...
    def __reduce_args__(self): # -> tuple[Any | None, Any | dict[Any, Any] | None, Any | str | None, None, str | Any, str | Any, str | Any, str | Any, Literal[False], Any | None]:
    ...
    @cached_property
    def annotations(self): # -> tuple[()] | list[MapAnnotation | mlazy | Any]:
        ...
