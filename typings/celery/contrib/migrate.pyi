...
def republish(producer, message, exchange=..., routing_key=..., remove_props=...): # -> None:
    """Republish message."""
    ...
...
def filter_callback(callback, tasks): # -> Callable[..., Any | None]:
    ...
...
def move(predicate, connection=..., exchange=..., routing_key=..., source=..., app=..., callback=..., limit=..., transform=..., **kwargs): # -> State:
...
def expand_dest(ret, exchange, routing_key): # -> tuple[Any, Any]:
    ...
...
def prepare_queues(queues): # -> dict[bytes, bytes]:
    ...
...
def start_filter(app, conn, filter, limit=..., timeout=..., ack_messages=..., tasks=..., queues=..., callback=..., forever=..., on_declare_queue=..., consume_from=..., state=..., accept=..., **kwargs): # -> State:
    """Filter tasks."""
    ...
...
def filter_status(state, body, message, **kwargs): # -> None:
    ...
