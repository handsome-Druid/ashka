...
def pyimplementation(): # -> str | LiteralString:
...
def detached(logfile=..., pidfile=..., uid=..., gid=..., umask=..., workdir=..., fake=..., **opts): # -> DaemonContext:
...
class Signals:
    ...
    ignored = ...
    default = ...
    def arm_alarm(self, seconds): # -> None:
        ...
    ...
    def __getitem__(self, name): # -> _HANDLER:
        ...
...
@contextmanager
def ignore_errno(*errnos, **kwargs): # -> Generator[None, Any, None]:
...
def check_privileges(accept_content): # -> None:
    ...
