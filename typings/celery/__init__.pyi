...
__docformat__ = ...
__keywords__ = ...
__all__ = ('Celery', 'bugreport', 'shared_task', 'Task', 'current_app', 'current_task', 'maybe_signature', 'chain', 'chord', 'chunks', 'group', 'signature', 'xmap', 'xstarmap', 'uuid')
VERSION_BANNER = ...
version_info_t = ...
_temp = ...
version_info = ...
...
if STATICA_HACK:
    ...
def maybe_patch_concurrency(argv=..., short_opts=..., long_opts=..., patches=...): # -> None:
