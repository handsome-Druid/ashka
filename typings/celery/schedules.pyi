...
class BaseSchedule:
    def __init__(self, nowfun: Callable | None = ..., app: Celery | None = ...) -> None:
        ...
    ...
    def maybe_make_aware(self, dt: datetime, naive_as_utc: bool = ...) -> datetime:
        ...
...
class schedule(BaseSchedule):
    ...
    """
    relative: bool = ...
    def __init__(self, run_every: float | timedelta | None = ..., relative: bool = ..., nowfun: Callable | None = ..., app: Celery | None = ...) -> None:
        ...
...
class crontab(BaseSchedule):
    ...
    """
    def __init__(self, minute: Cronspec = ..., hour: Cronspec = ..., day_of_week: Cronspec = ..., day_of_month: Cronspec = ..., month_of_year: Cronspec = ..., **kwargs: Any) -> None:
        ...
    ...
    def remaining_delta(self, last_run_at: datetime, tz: tzinfo | None = ..., ffwd: type = ...) -> tuple[datetime, Any, datetime]:
        ...
